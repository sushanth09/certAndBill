        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          var dataFactory = {
            year: function year(unixDate) {
              ...
              var activeYear = ngModelController.$modelValue ? moment(ngModelController.$modelValue).format('YYYY-MM-DD H:mm') : 0;
console.log(activeYear);
            ...
            month: function month(unixDate) {
              ...
              var activeDate = ngModelController.$modelValue ? moment(ngModelController.$modelValue).format('YYYY-MM-DD H:mm') : 0;
            ...
            day: function day(unixDate) {
              ...
              var activeDate = ngModelController.$modelValue ? moment(ngModelController.$modelValue).format('YYYY-MM-DD H:mm') : '';

...
FixedHeader = function ( mTable, oInit ) {
	...
	{
		console.log( "FixedHeader warning: FixedHeader must be initialised with the 'new' keyword." );
		return;
	}
...
FixedHeader.prototype = {
	...
	fnInit: function ( oDtSettings, oInit )
	{
		...
		{
			console.log( "FixedHeader 2 is not supported with DataTables' scrolling mode at this time" );
			return;
		}

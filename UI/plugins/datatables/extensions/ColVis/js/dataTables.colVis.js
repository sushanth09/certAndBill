...
var ColVis = function( oDTSettings, oInit )
{
	...
	{
		console.log( "Warning: ColVis must be initialised with the keyword 'new'" );
	}
...
{
	console.log( "Warning: ColVis requires DataTables 1.7 or greater - www.datatables.net/download");
}

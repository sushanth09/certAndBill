...
TableTools = function( oDT, oOpts )
{
	...
	{
		console.log( "Warning: TableTools must be initialised with the keyword 'new'" );
	}
	...
	"_fnButtonDefinations": function ( buttonSet, wrapper )
	{
		...
		for ( var i=0, iLen=buttonSet.length ; i<iLen ; i++ )
		{
			if ( typeof buttonSet[i] == "string" )
			{
				...
				{
					console.log( "TableTools: Warning - unknown button type: "+buttonSet[i] );
					continue;
				}
			...
			else
			{
				...
				{
					console.log( "TableTools: Warning - unknown button type: "+buttonSet[i].sExtends );
					continue;
				}
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		...
		"fnClick": function( nButton, oConfig ) {
			...
			$.ajax( {
				...
				"cache": false,
				"error": function () {
					console.log( "Error detected when sending table data to server" );
				}
			} );
		},
...
{
	console.log( "Warning: TableTools requires DataTables 1.9.0 or newer - www.datatables.net/download");
}
...
{
	console.log( "Warning: TableTools 2 requires DataTables 1.9.0 or newer - www.datatables.net/download");
}
